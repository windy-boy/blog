    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table0">
        <tr>
            ...
            <td style="height:30px; background:url(../img/tab/tab_05.gif);">
                <div class="topldiv"><img src="../img/tab/tb.gif"/>&nbsp; 你当前的位置：[系统管理]-[修改员工信息]</div>
                <div class="toprdiv">
        ...
        <tr>
            ...
            <td style=" padding:10px 0px;">
                <table class="table" cellspacing="1">
                    <caption>修改员账号与密码</caption>
                    <tr>
                        <th>账号</th>
                        <td>

                            <input name="name" type="text" readonly="true" Class="textbox" value="<?php echo  $_GET['action']; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <th>密码</th>
                        <td><input name="password" type="text" Class="textbox"/></td>
                    </tr>
                </table>
            </td>
